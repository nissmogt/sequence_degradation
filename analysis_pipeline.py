...
def pipeline_replicates(_sysid, _ncols, thresholds_list, npairs=0, zfilter=True, plots=False, passthrough=False):
    """
    ...
    """
    distance_cutoff = 8
    dir_system = os.path.join(root, "systems", _sysid)
    ...
    df_pdb = dpdb.pipeline_pdb(_sysid, "pdb")
